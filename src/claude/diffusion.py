"""
Diffusion Schedulers for DIFUSCO
================================
Implements both discrete (Bernoulli/Categorical) and continuous (Gaussian)
diffusion processes as described in Section 3.2 of the DIFUSCO paper.

Paper settings (Section 4.1):
  - T = 1000 denoising steps
  - Linear noise schedule: β_1 = 1e-4, β_T = 0.02
"""
...
# ============================================================
# Categorical (Discrete) Diffusion — Section 3.2 "Discrete Diffusion"
# ============================================================


class CategoricalDiffusion:
    """
    Discrete diffusion with Bernoulli noise (Austin et al., 2021).

    For TSP, each edge variable x_ij ∈ {0, 1} (in tour or not).
    The forward process corrupts x_0 toward Uniform({0,1}) by applying
    transition matrices Q_t at each timestep.
...
# ============================================================
# Gaussian (Continuous) Diffusion — Section 3.2 "Continuous Diffusion"
# ============================================================
...
class GaussianDiffusion:
    ...
    t-step marginal:
        q(x̃_t | x̃_0) = N(x̃_t; √(ᾱ_t) x̃_0, (1-ᾱ_t) I)

    The network predicts the unscaled noise:
        ε̃_t = (x̃_t - √(ᾱ_t) x̃_0) / √(1-ᾱ_t) = f_θ(x̃_t, t)
    """
...
# ============================================================
# Inference Schedule — Section 3.3 "Denoising Schedule for Fast Inference"
# ============================================================
